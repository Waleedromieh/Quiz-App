...
let submitBtn=document.querySelector('#startQuiz');
...
class Quiz{
    ...
    getApi(){
        return `https://opentdb.com/api.php?amount=${this.number}&category=${this.category}&difficulty=${this.difficulty}&type=multiple`
    }
